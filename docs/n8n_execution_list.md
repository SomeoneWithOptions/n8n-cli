...
```
  ...
  -h, --help                           help for list
      ...
      --status strings                 execution statuses, comma-separated or repeated: canceled, crashed, error, new, running, success, unknown, waiting; more than one fetches each status and merges newest first (default: every status)
